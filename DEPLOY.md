...
- 필수: `DATABASE_URL`, `SESSION_SECRET`, `ENCRYPTION_KEY`(64자 hex=32byte, 주민번호 AES-256-GCM), `CORS_ORIGIN`, `PUBLIC_BASE_URL`(=https://class.lawciety.com).
...
- **카카오 공유**: 카카오 개발자센터 앱 — 웹 플랫폼에 `https://class.lawciety.com` 등록 + JS 키 발급.
...
## 6. 검증 체크리스트(배포 후)
- `curl https://class.lawciety.com/cases/<id>` → 사건별 OG 메타 주입 확인.
