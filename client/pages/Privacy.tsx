...
export default function Privacy() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="text-base text-gray-500 mb-8">시행일: 2026년 7월 1일 | 버전 2.1</p>
      ...
      <div className="text-base leading-relaxed text-gray-700">
        ...
        <section className="border rounded-lg p-5 mb-6">
          ...
          <p className="mb-3">회사는 다음의 목적을 위하여 개인정보를 처리하며, 목적 외의 용도로는 이용하지 않습니다. 처리 목적이 변경되는 경우 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행합니다.</p>
        ...
        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제2조 (처리하는 개인정보의 항목 및 수집 방법)</h2>
          <p className="mb-3">① 회사는 다음의 개인정보 항목을 처리합니다.</p>
          ...
          <p className="mt-3">② <strong>고유식별정보(주민등록번호):</strong> 소장 작성 등 소송 수행에 필요한 경우에 한하여 「개인정보 보호법」 제24조의2에 따라 <strong>일반 개인정보와 별도로 동의</strong>를 받아 수집하며, 수집 시 <strong>AES-256-GCM으로 암호화</strong>하여 저장하고 소송 수행 목적 외에는 이용하지 않습니다.</p>
          <p className="mt-2">③ <strong>소송 상대방(피고·채무자) 정보:</strong> 소송 수행을 위해 상대방의 성명·주소·연락처·주민등록번호 또는 법인등록번호 등을 처리할 수 있습니다. 이는 정보주체 본인이 아닌 제3자의 정보로서, 「개인정보 보호법」 제15조 제1항 제6호(개인정보처리자의 정당한 이익) 및 제7호(법적 청구권의 행사·입증·방어)에 근거하여 소송 목적에 필요한 최소한의 범위에서 처리하며, 주민등록번호 등은 암호화하여 보관합니다. 해당 제3자는 같은 법 제20조에 따라 처리 출처·목적의 고지 및 처리정지를 요구할 수 있습니다.</p>
          <p className="mt-2">④ <strong>수집 방법:</strong> 회원가입·참여신청 폼 직접 입력, 소셜 로그인 제공자로부터 제공받음, 증거 파일 업로드, 서비스 이용 중 자동 생성·수집.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제3조 (개인정보의 처리 및 보유 기간)</h2>
          <p className="mb-3">회사는 법령상 보유기간 또는 정보주체로부터 동의받은 기간 내에서 개인정보를 처리·보유하며, 기간 경과 또는 처리목적 달성 시 지체 없이 파기합니다.</p>
        ...
        <section className="border rounded-lg p-5 mb-6">
          ...
          <p className="mb-3">회사는 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조·제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
        ...
        <section className="border rounded-lg p-5 mb-6">
          ...
          <p className="mb-3">회사는 원활한 업무처리를 위하여 아래와 같이 개인정보 처리업무를 위탁합니다. 위탁계약 시 「개인정보 보호법」 제26조에 따라 처리목적 외 이용금지, 기술적·관리적 보호조치, 재위탁 제한, 수탁자 관리·감독, 손해배상 등의 책임에 관한 사항을 문서에 명시하고 수탁자가 개인정보를 안전하게 처리하는지 감독합니다.</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
          ...
          <p className="mt-3 text-sm text-gray-500">※ 나이스페이먼츠(결제)·본인확인기관·소셜 로그인 제공자는 계약 구조에 따라 수탁자가 아닌 독립한 개인정보처리자에 해당할 수 있으며, 이 경우 해당 사업자의 개인정보 처리방침이 함께 적용됩니다.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제6조 (개인정보의 국외 이전)</h2>
          <p className="mb-3">회사는 다음과 같이 개인정보가 국외로 이전될 수 있습니다(「개인정보 보호법」 제28조의8). 위탁·보관 목적의 이전은 본 방침의 공개로 갈음할 수 있습니다.</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
          ...
          <p className="mt-3">정보주체는 국외 이전을 거부할 수 있으며, 거부 시 해당 소셜 로그인·이메일 채널의 이용이 제한될 수 있습니다(국내 수단으로 대체 가능). 문의: 아래 개인정보 보호책임자.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제7조 (개인정보의 파기절차 및 방법)</h2>
          <p>① 파기 절차: 보유기간 경과 또는 처리목적 달성으로 불필요하게 된 개인정보는 내부 방침 및 관계 법령에 따른 보존기간 경과 후 지체 없이 파기합니다.</p>
          <p className="mt-2">② 파기 방법: 전자적 파일은 복구가 불가능한 방법으로 영구 삭제하며, 출력물은 분쇄기로 분쇄하거나 소각합니다. 본인 탈퇴 시 당사자 정보의 성명·연락처·주소·주민등록번호·피해내용·전자서명 등은 즉시 삭제·익명화합니다(법령상 보존의무가 있는 정보는 그 기간 후 파기).</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제8조 (미이용자의 개인정보 파기 등에 관한 조치)</h2>
          <p>회사는 장기간(예: 1년) 서비스를 이용하지 않은 회원의 개인정보를 보호하기 위하여, 관련 법령이 정하는 바에 따라 해당 개인정보를 파기하거나 별도로 분리하여 보관할 수 있으며, 분리 보관·파기 전 정보주체에게 사전 통지합니다.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제9조 (정보주체와 법정대리인의 권리·의무 및 행사 방법)</h2>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>자동화된 결정에 대한 거부·설명 요구권(제37조의2):</strong> 제14조 참조</li>
          </ul>
          <p className="mt-3">권리 행사는 서비스 내 설정 메뉴 또는 아래 개인정보 보호책임자에게 서면·전자우편 등으로 하실 수 있으며, 회사는 지체 없이 조치합니다. 법정대리인 또는 위임받은 자를 통해서도 행사할 수 있습니다. 정보주체가 정정 또는 삭제를 요구한 경우, 회사는 정정·삭제가 완료될 때까지 해당 개인정보를 이용·제공하지 않습니다(법령상 보존의무가 있는 정보는 그 기간 경과 후 처리).</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제10조 (개인정보의 안전성 확보 조치)</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제11조 (개인정보 자동 수집 장치의 설치·운영 및 거부 — 쿠키)</h2>
          <p>회사는 로그인 유지 및 서비스 제공을 위해 세션 쿠키를 사용합니다. 이용자는 브라우저 설정을 통해 쿠키 저장을 거부할 수 있으나, 이 경우 로그인 등 일부 기능 이용이 제한될 수 있습니다.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제12조 (행태정보의 수집·이용·제공 및 거부 등)</h2>
          <p>회사는 온라인 맞춤형 광고를 목적으로 행태정보를 별도로 수집·이용·제공하지 않습니다.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제13조 (민감정보의 처리 및 공개 가능성)</h2>
          <p>회사는 민감정보를 별도로 수집하지 않습니다. 다만 소송의 성질상 이용자가 자발적으로 제공하는 참여신청 내용·증거 자료에는 사건과 관련된 민감정보(건강·범죄경력 등)가 포함될 수 있습니다. 이 경우 회사는 소송 수행에 필요한 최소한의 범위에서 처리하고, 제10조의 안전성 확보조치 및 변호사의 비밀유지의무(「변호사법」 제26조)에 따라 보호합니다. 제출 자료에 제3자(소송 상대방 등)의 정보가 포함되는 경우 「개인정보 보호법」 제15조 제1항 제6호·제7호(정당한 이익 및 법적 청구권의 행사·입증·방어)에 근거하여 처리할 수 있습니다(제2조 제3항 참조).</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제14조 (자동화된 결정에 관한 사항)</h2>
        ...
        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제15조 (가명정보 처리)</h2>
          <p>회사는 통계작성, 과학적 연구 등을 위한 가명정보를 별도로 처리하지 않습니다.</p>
        </section>

        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제16조 (개인정보 보호책임자 및 열람청구 접수·처리 부서)</h2>
          <p className="mb-3">회사는 개인정보 처리에 관한 업무를 총괄하여 책임지고, 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
          <table className="w-full text-sm border-collapse">
            <tbody>
        ...
        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제17조 (정보주체의 권익침해에 대한 구제 방법)</h2>
          <p className="mb-3">정보주체는 개인정보 침해로 인한 구제를 받기 위하여 아래 기관에 분쟁해결·상담 등을 신청할 수 있습니다.</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="border rounded-lg p-5 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3">제18조 (개인정보처리방침의 변경)</h2>
          <p className="mb-3">이 개인정보처리방침은 2026년 7월 1일부터 적용됩니다. 법령·서비스 변경에 따라 개정될 수 있으며, 변경 시 시행 7일 전(중대한 변경은 30일 전)부터 서비스 내 공지를 통해 안내합니다.</p>
          <ul className="list-disc pl-5 space-y-1 text-sm text-gray-500">
            <li>v2.1 (2026-07-01): 표준 양식 정합(조문 구조 통일) — 미이용자 파기(제8조)·민감정보(제13조) 조문 신설, 행태정보(제12조)와 자동화된 결정(제14조) 분리, 전조 재배열·재번호</li>
